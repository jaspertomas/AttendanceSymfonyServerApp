...
abstract class BaseAccountEntryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'android_id'      => new sfWidgetFormFilterInput(),
      'android_user_id' => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'android_id'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'android_user_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ));
