 ...
 * @method SfGuardGroupPermission setCreated_at()        Sets the current record's "created_at" value
 * @method SfGuardGroupPermission setUpdated_at()        Sets the current record's "updated_at" value
