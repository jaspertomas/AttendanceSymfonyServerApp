 ...
 * @method SfGuardPermission   setCreated_at()             Sets the current record's "created_at" value
 * @method SfGuardPermission   setUpdated_at()             Sets the current record's "updated_at" value
