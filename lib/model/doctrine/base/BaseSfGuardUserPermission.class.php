 ...
 * @method SfGuardUserPermission setCreated_at()        Sets the current record's "created_at" value
 * @method SfGuardUserPermission setUpdated_at()        Sets the current record's "updated_at" value
