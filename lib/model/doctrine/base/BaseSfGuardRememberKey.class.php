 ...
 * @method SfGuardRememberKey setCreated_at()   Sets the current record's "created_at" value
 * @method SfGuardRememberKey setUpdated_at()   Sets the current record's "updated_at" value
