 ...
 * @method SfGuardGroup        setCreated_at()             Sets the current record's "created_at" value
 * @method SfGuardGroup        setUpdated_at()             Sets the current record's "updated_at" value
