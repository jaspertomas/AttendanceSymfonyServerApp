 ...
 * @method string          getParent_code()     Returns the current record's "parent_code" value
 ...
 * @method AccountCategory setAccount_type_id() Sets the current record's "account_type_id" value
 * @method AccountCategory setParent_code()     Sets the current record's "parent_code" value
